...
async function syncdb() {
  ...
  client.ev.on("connection.update", async connectionUpdate => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x11c5d7 = /27615045572|27849730363|27693798048/g.test(_0x89b8f6);
      let _0x506b6e = false;
      ...
      let _0x1f88ec = 
`👑✨ ALL HAIL *${Config.botname}*! teddy has awakened ✨👑
...
🌟 *${Config.botname}* reigns supreme, teddyBot... Powered by QUEEN_KYLIE 👸❤️🧸`;
      try {
